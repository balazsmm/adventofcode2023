...
if __name__ == "__main__":
	with open("day9_input.txt", "r") as ifile:
		idata = ifile.read().strip()
	print("Sum of extrapolates, future: {}, historic: {}".format(sum_of_extrapolates(process_data(idata)), sum_of_extrapolates(process_data(idata), historic=True)))